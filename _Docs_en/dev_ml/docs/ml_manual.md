...
**Open Project**: Click this button, select the desired project in the popup window, and double-click to open it; then click the "OK" button.
**Import CSV File**: Click this button to open a window for selecting the path of the file to import. After selecting the target file, click OK.
...
Video Mode: Right-click ![](./images_ml_manual/media/image11.png) or click the Video Mode drop-down box to switch the view mode of each camera.
