...
![](./images_ms/media/image5.png)

![](./images_ms/media/image6.png)

**5.在视频号直播界面右上角，点击"\..."-"设置"，可对麦克风、扬声器、画布大小及是否显示鼠标进行设置**

![](./images_ms/media/image7.png)

![](./images_ms/media/image8.png)

**6点击发起直播后，可修改直播分类、添加直播描述及修改封面，确认无误后，点击"开始直播**

![](./images_ms/media/image9.png)

**7.直播开始后，可在画面右侧看到当前在线人数及用户评论，也可一键关闭评论**

![](./images_ms/media/image10.png)

**8.直播结束后，可查看本场直播数据。也可点击【数据详情】，前往视频号助手管理端查看详细数据分析**

![](./images_ms/media/image11.png)
