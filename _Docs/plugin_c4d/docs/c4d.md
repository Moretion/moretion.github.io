...
![](./images/media/image1.png){width="2.5208333333333335in"
height="0.3333333333333333in"}

2.  点击下一步

![](./images/media/image2.png){width="5.25in"
...
![](./images/media/image3.png){width="5.25in" height="4.28125in"}

4.  选择插件安装位置，安装在默认目录下。默认会选择用户的AppData\\Roaming目录下的Maxon文件夹（即C:\\Users\\\<用户名\>\\AppData\\Roaming\\Maxon）。然后点击下一步。

![](./images/media/image4.png){width="5.25in" height="4.3125in"}

5.  点击下一步开始安装，在弹出的确认框中选择继续。

![](./images/media/image5.png){width="5.25in" height="4.28125in"}

6.  如下图所示，插件安装完成。

![](./images/media/image6.png){width="5.25in"
height="4.291666666666667in"}

7.  打开Cinema4D，按下Ctrl+E打开设置窗口，在右侧点击插件，检查搜索路径中是否已经包含插件所安装的目录，即AppData\\Roaming\\Maxon\\MotionStudioPlugin。

![](./images/media/image7.png){width="7.791666666666667in"
height="4.430775371828521in"}
...
![](./images/media/image8.png){width="7.791666666666667in"
height="4.713182414698163in"}

点击后，会弹出插件的连接设置界面

![](./images/media/image9.png){width="7.572916666666667in"
height="4.40625in"}
...
![](./images/media/image10.png){width="4.375in"
...
![](./images/media/image11.png){width="6.416666666666667in"
height="4.0in"}
...
![](./images/media/image12.png){width="7.604166666666667in"
height="4.166666666666667in"}

3.关于插件，此处可以访问官网，查看插件的版本，打开本插件指南，以及检查插件更新。

![](./images/media/image13.png){width="7.791666666666667in"
height="4.0004472878390205in"}
...
![](./images/media/image14.png){width="5.864583333333333in"
...
![](./images/media/image17.png){width="5.75in" height="3.65625in"}
...
![](./images/media/image23.png){width="4.177083333333333in"
height="9.729166666666666in"}
...
height="4.593128827646544in"}

![](./images/media/image27.png){width="7.791666666666667in"
height="3.786958661417323in"}
...
height="4.572241907261592in"}

如下，Hips骨骼右侧多了角色定义图标。

![](./images/media/image29.png){width="3.9375in"
...
height="3.6789162292213473in"}

在角色定义窗口中，点击提取骨架，可以自动将角色的骨骼映射到通用骨架上。

![](./images/media/image31.png){width="6.5625in"
...
![](./images/media/image32.png){width="7.5in"
...
![](./images/media/image33.png){width="7.395833333333333in"
height="7.59375in"}

在Hips骨骼的右侧添加解析器图标

![](./images/media/image34.png){width="6.3125in" height="8.34375in"}
...
height="4.225988626421698in"}

再次点击可以停止录像，此时会暂停动作同步。点击C4D下方动画轨道中的播放
按钮，可以回看刚才录制的动作。

![](./images/media/image37.png){width="7.791666666666667in"
height="4.613739063867016in"}
